...
export default function PostGenerator() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf0ec] p-8 flex flex-col items-center gap-10">
      ...
      {/* Wrapper to allow horizontal scrolling on small phones so the meme doesn't get squished */}
      <div className="w-full max-w-xl border border-dashed border-[#d4907a] bg-gray-50 rounded-xl relative overflow-x-auto p-4 custom-scrollbar">
          ...
          <div ref={cardRef} className="bg-white p-12 w-[600px] h-[600px] flex flex-col justify-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col justify-center">
                ...
                <span className="text-[#6b635e] text-[15px] leading-tight mt-0.5">
                  @sanctuary.daily
                </span>
              </div>
            </div>
