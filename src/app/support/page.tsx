  ...
  return (
    <div className="min-h-screen bg-[#fbf5f2] text-[#1f3a28] pb-24 md:pb-12">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-emerald-900/10 bg-[#fbf5f2]/95 py-2.5 backdrop-blur-md md:hidden shadow-lg">
        <a href="/dashboard" className="flex flex-col items-center text-[11px] font-medium text-emerald-800/80 hover:text-emerald-900">
        ...
        <a href="/dashboard/saved" className="flex flex-col items-center text-[11px] font-medium text-emerald-800/80 hover:text-emerald-900">
        ...
        <a href="/support" className="flex flex-col items-center text-[11px] font-medium text-emerald-900">
